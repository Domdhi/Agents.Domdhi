...
**CSO linter** — every skill's `description:` field must start with `"Use WHEN"` to satisfy the Conditional Skill Orchestration rule (see `writing-skills/SKILL.md` and `system-builder/SKILL.md`). Shell check:
