...
description: "Use WHEN capturing strategic product vision or creating a project brief that will feed downstream PRD and architecture work. Triggers: project brief, vision, strategic, planning"
metadata:
  version: 1.0.0
  author: Domdhi.Agents
  tags: [project-brief, vision, strategy, planning]
...
## Cross-References
- Reads from: brainstorm/research docs if available — path depends on context: feature-scoped work uses `docs/app/{feature}/brainstorm.md` or `docs/app/{feature}/research.md`; general research uses `docs/.output/research/{date}-{slug}.md`
