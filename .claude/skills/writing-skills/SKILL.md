...
description: "Use WHEN [specific triggering conditions and symptoms]. Triggers: keyword1, keyword2"
metadata:
  version: 1.0.0
  author: Domdhi.Agents
  tags: [tag1, tag2]
...
**Testing methodology:** See `.claude/skills/writing-skills/testing-skills-with-subagents.md` for the complete testing methodology:
