...
- `.claude/skills/using-git-worktrees/SKILL.md` — isolate feature work on a clean branch first
- `.claude/skills/verification-before-completion/SKILL.md` — after all tasks complete, verify the full implementation
- `.claude/skills/finishing-a-development-branch/SKILL.md` — merge/PR/keep/discard decision after the full review passes
