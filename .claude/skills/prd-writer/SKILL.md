---
name: prd-writer
description: "Use WHEN writing a product requirements document, defining functional or non-functional requirements, or applying MoSCoW prioritization. Triggers: prd, requirements, functional requirements, non-functional requirements, user stories"
metadata:
  version: 1.0.0
  author: Domdhi.Agents
  tags: [prd, requirements, product-management, MoSCoW, user-stories]
