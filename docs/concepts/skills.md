...
| `project-planning` | `product-strategist`, `project-planner`, `doc-writer` agents + `/brainstorm`, `/research`, `/create:project-brief`, `/create:project-requirements`, `/create:project-epics`, `/create:project-todo`, `/create:project-epics-todo`, `/review:optimize-backlog`, `/review:check-readiness`, `/review:changelog`, `/review:update-docs`, `/review:retro` | Consolidated planning-pipeline authoring: brief, PRD, backlog (epics/stories), project-context quick-ref — templates + guidance in `references/`/`assets/` (folded in epic-writer + project-context) |
